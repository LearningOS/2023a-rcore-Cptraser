...
impl TaskControlBlock {
    ...
    /// get priority number
    pub fn get_priority_number(&self) -> usize {
        self.inner_exclusive_access().priority
    }
    /// Update syscall time by syscall id
    ...
    pub fn set_current_priority(&self, to_set_priority: usize) {
        let mut inner = self.inner_exclusive_access();
        inner.priority = to_set_priority;
    }
    /// Update Stride Number
    pub fn update_stride_number(&self) {
        let mut inner = self.inner_exclusive_access();
...
impl TaskControlBlock {
    ...
    /// Munmap from start_va to end_va only when exist same
    pub fn pg_munmap(
        &self,
        start_va: VirtAddr,
        end_va: VirtAddr,
        ...
        let mut inner = self.inner.exclusive_access();
        inner.memory_set.delete_frame_area(start_va, end_va);
    }
}
